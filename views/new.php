            ...
            <div class="card-body">
              <form>
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="productPrice" value="10.00">
                </div>
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="productObservations" rows="3" placeholder="Observações sobre o produto" required></textarea>
                </div>
